      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => (
          ...
          >
            ...
            {visible.includes(message._id)?<div className="btn btn-outline btn-warning " onClick={()=>{deleteNow("del",message._id,message.senderId,message.receiverId)}}>Delete</div>:<div></div>}
